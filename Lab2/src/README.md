# Лабораторная 2. Стеки, очереди, СНМ.
...
* **Входные данные:**
В первой строке дано целое число **n (1≤n≤10^5)** — количество событий.
В каждой из следующих **n** строк дано описание событий: номер события, а также число **id (1≤id≤10^5)** для событий типа **1** и число **q** для событий типа **4**.
